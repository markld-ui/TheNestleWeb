...
namespace Thenestle.Persistence.Data.Migrations
{
    ...
    [Migration("20250621165642_SomeChengesUser")]
    partial class SomeChengesUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.Couple", b =>
                {
                    ...
                    b.ToTable("couple", "couple_app", t =>
                        {
                            t.HasCheckConstraint("ck_couple_users", "user1_id < user2_id");
                        });
                });
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.Couple", b =>
                {
                    b.HasOne("Thenestle.Domain.Models.User", "User1")
                        .WithMany()
                    ...
                    b.HasOne("Thenestle.Domain.Models.User", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.CurrencyTransaction", b =>
                {
                    ...
                    b.HasOne("Thenestle.Domain.Models.User", "User")
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.FoodOrder", b =>
                {
                    b.HasOne("Thenestle.Domain.Models.User", "Initiator")
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.Invite", b =>
                {
                    ...
                    b.HasOne("Thenestle.Domain.Models.User", "Inviter")
                        .WithMany()
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.Place", b =>
                {
                    b.HasOne("Thenestle.Domain.Models.User", "AddedBy")
                        .WithMany("Places")
            ...
            modelBuilder.Entity("Thenestle.Domain.Models.Reminder", b =>
                {
                    b.HasOne("Thenestle.Domain.Models.User", "CreatedBy")
                        .WithMany("Reminders")
